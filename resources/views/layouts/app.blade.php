...
<nav class="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
    ...
    <div class="flex items-center gap-5 text-sm">
        <a href="{{ route('dashboard') }}" class="text-gray-500 hover:text-gray-900 transition">Dashboard</a>
        ...
        <form method="POST" action="{{ route('logout') }}" class="inline">
            @csrf
            <button type="submit" class="text-gray-400 hover:text-gray-700 transition">Logout</button>
        </form>
    </div>
</nav>
